                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-lg-12">
								<div class="card-box">
									<h4 class="m-t-0 header-title"><b>Add Product Category</b></h4>
									<p class="text-muted font-13 m-b-30">
	                                    Please fill the form to add product category.
	                                </p>
		                                        
									<form action="product_category_process.php" method="post">
										<div class="form-group">
											<label for="userName">Name *</label>
											<input type="text" name="title" parsley-trigger="change" required placeholder="Enter user name" class="form-control" id="userName">
										</div>
										<!-- <div class="form-group">
