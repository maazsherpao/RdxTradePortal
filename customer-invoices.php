<!-- ========== Get Page Header ========== -->
            ...
            include_once('functions.php');
              ...
              $statement = "order_detail ORDER BY created_date DESC"; // Change `records` according to 
                                              ...
                                              ?>
                                               <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="view-customer-invoice.php?id=<?php echo $row['invoice_no'];?>" class="table-action-btn"><i class="fa fa-eye"></i></a>
