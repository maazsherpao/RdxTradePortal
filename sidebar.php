                    ...
                    <div id="sidebar-menu">
                        <ul id="navLinks">
                           ...
                           <?php if(isset($_SESSION['type']) && $_SESSION['type'] == 'super'){?>
                            <li class="has_sub">
                                <a href="manage_admins.php" class="waves-effect"><i class="ti-user"></i> <span> Manage Admins </span> </a>
                                <!-- <ul class="list-unstyled">
                                    <li class="active"><a href="index.html">Dashboard 1</a></li>
                                    <li><a href="dashboard_2.html">Dashboard 2</a></li>
                                    <li><a href="dashboard_3.html">Dashboard 3</a></li>
                            ...
                            <li class="has_sub">
                                <a href="product.php" class="waves-effect"><i class="fa fa-cubes"></i><span> Products </span></a>
                                <ul class="list-unstyled">
                                ...
                                <li class="has_sub">
                                <a href="customer-invoices.php" class="waves-effect"><i class="fa fa-user"></i><span> My Invoices </span></a>
                                <ul class="list-unstyled">
                                    <!-- <li><a href="ecommerce-dashboard.html"> Dashboard</a></li> -->
                                    <!-- <li><a href="ecommerce-products.html"> All Products</a></li> -->
                                    <!-- <li><a href="ecommerce-product-detail.html"> Product Detail</a></li>
                                 ...
                                 <?php } else {?>
                                  <li class="has_sub">
                                <a href="invoices.php" class="waves-effect"><i class="fa fa-user"></i><span> Invoices </span></a>
                                <ul class="list-unstyled">
                                    <!-- <li><a href="ecommerce-dashboard.html"> Dashboard</a></li> -->
                                    <!-- <li><a href="ecommerce-products.html"> All Products</a></li> -->
                                    <!-- <li><a href="ecommerce-product-detail.html"> Product Detail</a></li>
                            ...
                            <li class="has_sub">
                                <a href="product_categories.php" class="waves-effect"><i class="fa fa-sitemap"></i><span> Product Categories </span></a>
                                <ul class="list-unstyled">
                                    <!-- <li><a href="ecommerce-dashboard.html"> Dashboard</a></li> -->
                                    <!-- <li><a href="ecommerce-products.html"> Product Categories</a></li> -->
                                    <!-- <li><a href="ecommerce-product-detail.html"> Product Detail</a></li>
                                    <li><a href="ecommerce-orders.html"> Orders</a></li>
                                    <li><a href="ecommerce-sellers.html"> Sellers</a></li> -->
                                </ul>
                            ...
                            <!--  <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="fa fa-dollar"></i><span> Billing </span></a>
                                <ul class="list-unstyled">
                                    <li><a href="ecommerce-dashboard.html"> Dashboard</a></li> 
                                     <li><a href="ecommerce-products.html"> Invoices</a></li> 
                                     <li><a href="ecommerce-product-detail.html"> Product Detail</a></li>
                                    <li><a href="ecommerce-orders.html"> Orders</a></li>
                                    <li><a href="ecommerce-sellers.html"> Sellers</a></li>
                                </ul>
                            ...
                            <li class="has_sub">
                                <a href="orders.php" class="waves-effect"><i class="fa fa-shopping-cart"></i><span> Orders </span></a>
                                <ul class="list-unstyled">
                                    <!-- <li><a href="ecommerce-dashboard.html"> Dashboard</a></li> -->
                                    <!-- <li><a href="ecommerce-products.html"> All Orders</a></li> -->
                                    <!-- <li><a href="ecommerce-product-detail.html"> Product Detail</a></li>
                                    <li><a href="ecommerce-orders.html"> Orders</a></li>
                                    <li><a href="ecommerce-sellers.html"> Sellers</a></li> -->
                                </ul>
                           ...
                           <!-- <li class="has_sub">
                                <a href="products.php" class="waves-effect"><i class="ti-paint-bucket"></i> <span> Products </span> </a>
                                 <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="customers.php" class="waves-effect"><i class="fa fa-user"></i><span> Customers </span> </a>
                                <!-- <ul class="list-unstyled">
                            ...
                            <li class="has_sub">
                                <a href="customer_currency.php" class="waves-effect"><i class="fa fa-money"></i><span> Customer's Currency </span> </a>
                            </li>
 ...
 -->
        ...
        <script>   
         ...
         function setActive() {
         aObj = document.getElementById('navLinks').getElementsByTagName('a');
