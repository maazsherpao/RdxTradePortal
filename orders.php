                        		...
                        		<div class="card-box">
                        			...
                        			<div class="table-responsive">
                                        <table class="table table-actions-bar">
                                            ...
                                            <?php
                                        $stmt = $db_con->prepare("SELECT * FROM order_detail
                                        ...
                                        ?>
                                                <tr>
                                                   ...
                                                   // $count = $stmt->rowCount(); 
                                                    ...
                                                    <td>
                                                    	<a href="order_edit.php?id=<?php echo $row['invoice_no'];?>" class="table-action-btn"><i class="md md-edit"></i></a> 
                                                    	<a href="#" id="<?php echo $row['id'];?>" class="table-action-btn remove-row"><i class="md md-close"></i></a>
                                                    </td>
                                                </tr>
                                         <?php } }else{?> 
                                         <tr><td>No Records Fond!</td></tr>
                                         <?php }?>     
