                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="m-b-30">
                                            ...
                                            <button id="addToTable" class="btn btn-default waves-effect waves-light" onclick="location.href='add_product.php'">

                                            Add Product <i class="fa fa-plus"></i></button>
                                    ...
                                    <table class="table table-striped" id="datatable-editable">
                                        ...
                                        ?>
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td><img src="assets/images/products/<?php echo $row['image'];?>" class="thumb-sm" alt=""> </td>
                                                ...
                                                <td><?php if($row['out_of_stock'] != 1) echo "YES"; else echo "NO";?></td>
                                                ...
                                                <td class="actions">
                                                    ...
                                                    <a href="edit_product.php?id=<?php echo $row['id'];?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
