                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="bg-picture text-center">
                                ...
                                <button class="btn btn-pink waves-effect waves-light" onclick="location.href='customer_edit_profile.php'"> <span>Edit Profile</span> <i class="fa fa-user-plus"></i></button>
                                <button class="btn btn-pink waves-effect waves-light" onclick="location.href='customer_change_password.php'"> <span>Change Password</span> <i class="fa fa-lock"></i> </button>
                                </div>
                            </div>
                            <!--/ meta -->
                        </div>
                    		...
                    		<div class="card-box m-t-20">
								...
								<div class="p-20">
									<div class="about-info-p">
                                        ...
                                        <br>
                                        <p class="text-muted"><?php echo $rows['first_name']." ".$rows['last_name'];?></p>
                                    </div>
                                    <div class="about-info-p">
                        ...
                        <div class="col-md-8">
                        	...
                        	<div class="card-box">
					            ...
					            <div class="gmap-info">
					                ...
					                <p><?php echo $rows['street_address'];?> </p>
